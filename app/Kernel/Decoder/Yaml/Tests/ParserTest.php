...
namespace Kernel\Decoder\Yaml\Tests;

use Kernel\Decoder\Yaml\Yaml;
use Kernel\Decoder\Yaml\Parser;
...
EOF;
    ...
    {
        $input = <<<EOF
foo: !!php/object:O:30:"Kernel\Decoder\Yaml\Tests\B":1:{s:1:"b";s:3:"foo";}
bar: 1
EOF;
...
EOF;
    ...
    /**
     * @expectedException \Kernel\Decoder\Yaml\Exception\ParseException
     */
        ...
        foreach ($yamls as $yaml) {
            try {
                ...
                $this->fail('charsets other than UTF-8 are rejected.');
                 ...
                 $this->assertInstanceOf('Kernel\Decoder\Yaml\Exception\ParseException', $e, 'charsets other than UTF-8 are rejected.');
            }
        }
    }
